...
Not: Model dosyaları büyük olabilir ve .gitignore ile dışlanmış olabilir. Bu durumda, [link] adresinden indirebilirsiniz.

Repoyu klonlayın git clone https://github.com/yuuyunie/emlak-ilanlari-eslestirme-uygulamasi.git cd emlak-ilanlari-eslestirme-uygulamasi
Bağımlılıkları yükleyin (yukarıdaki adımı takip edin).
Veri dosyalarını ve Word2Vec modellerini ana dizine yerleştirin.
Jupyter Notebook’u başlatın:
jupyter notebook
emlak_projesi_2.ipynb dosyasını açın ve tüm hücreleri sırayla çalıştırın.
Çıktılar şu dosyalarda kaydedilecektir:
